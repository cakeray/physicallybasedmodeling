...
void ConfigurePlanes() {
    planePositions[0] = glm::vec3(5.0f, 0.0, 0.0);
    planePositions[1] = glm::vec3(-5.0f, 0.0, 0.0);
    planePositions[2] = glm::vec3(0.0, 5.0f, 0.0);
    planePositions[3] = glm::vec3(0.0, -5.0f, 0.0);
    planePositions[4] = glm::vec3(0.0, 0.0, 5.0f);
    planePositions[5] = glm::vec3(0.0, 0.0, -5.0f);
...
glm::vec3 UpdatePosition(glm::vec3 ballPosition) {
    static glm::vec3 velocity = glm::vec3(0, 0.8, 0);      //  starting velocity
...
bool CollisionCheck(glm::vec3 position) {
    ...
    float radius = 1.0f;
    glm::vec3 difference = position - planePositions[3];
    //std::cout << "Diff: " << difference.x <<" "<<difference.y<<" "<<difference.z << std::endl;
    float dotProd = glm::dot(difference, planeNormals[3]);
